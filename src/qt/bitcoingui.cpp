                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Traff Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Traff address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and traff: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTRAFF"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Traff Core"), this);
    aboutAction->setStatusTip(tr("Show information about Traff Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Traff"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Traff addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Traff addresses"));
    ...
    openAction->setStatusTip(tr("Open a Traff: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Traff Core help message to get a list with possible Traff command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Traff Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Traff network", "", count));
}
...
{
    QString strTitle = tr("Traff Core"); // default title
