...
/** Utility functions used by the Traff Qt UI.
 */
namespace GUIUtil
{
...
// Render Traff addresses in monospace font
...
// Parse "traff:" URI into recipient object, return true on successful parsing
