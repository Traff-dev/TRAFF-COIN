...
public:
    ...
    void setZTRAFFControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzTRAFF_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzTRAFF_clicked();
    void on_pushButtonZTRAFFControl_clicked();
