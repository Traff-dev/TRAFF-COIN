                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received TRAFF from zTRAFF"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTRAFF"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTRAFF));
