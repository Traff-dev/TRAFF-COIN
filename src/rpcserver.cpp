...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Traff features */
        {"traff", "masternode", &masternode, true, true, false},
        {"traff", "listmasternodes", &listmasternodes, true, true, false},
        {"traff", "getmasternodecount", &getmasternodecount, true, true, false},
        {"traff", "masternodeconnect", &masternodeconnect, true, true, false},
        {"traff", "masternodecurrent", &masternodecurrent, true, true, false},
        {"traff", "masternodedebug", &masternodedebug, true, true, false},
        {"traff", "startmasternode", &startmasternode, true, true, false},
        {"traff", "createmasternodekey", &createmasternodekey, true, true, false},
        {"traff", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"traff", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"traff", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"traff", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"traff", "getmasternodescores", &getmasternodescores, true, true, false},
        {"traff", "mnbudget", &mnbudget, true, true, false},
        {"traff", "preparebudget", &preparebudget, true, true, false},
        {"traff", "submitbudget", &submitbudget, true, true, false},
        {"traff", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"traff", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"traff", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"traff", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"traff", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"traff", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"traff", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"traff", "checkbudgets", &checkbudgets, true, true, false},
        {"traff", "mnsync", &mnsync, true, true, false},
        {"traff", "spork", &spork, true, true, false},
        {"traff", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"traff", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use traffd, or the -server option to traff-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> traff-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:61021/\n";
}
