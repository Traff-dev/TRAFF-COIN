...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Traff Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  traff-cli [options] <command> [params]  " + _("Send command to Traff Core") + "\n" +
                        "  traff-cli [options] help                " + _("List commands") + "\n" +
                        "  traff-cli [options] help <command>      " + _("Get help for a command") + "\n";
