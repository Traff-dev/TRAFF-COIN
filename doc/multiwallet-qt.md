...
In order to support loading of multiple wallets in traff-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is traff.cpp.
...
Changes to traff.cpp
----------------------
traff.cpp is the entry point into traff-qt, and as such, will require some minor modifications to provide hooks for
