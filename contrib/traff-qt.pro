...
RESOURCES += src/qt/traff.qrc src/qt/traff_locale.qrc

TRANSLATIONS += src/qt/locale/traff_bg.ts \
                src/qt/locale/traff_de.ts \
                src/qt/locale/traff_en.ts \
                src/qt/locale/traff_es.ts \
                src/qt/locale/traff_fi.ts \
                src/qt/locale/traff_fr.ts \
                src/qt/locale/traff_it.ts \
                src/qt/locale/traff_ja.ts \
                src/qt/locale/traff_pl.ts \
                src/qt/locale/traff_pt.ts \
                src/qt/locale/traff_ru.ts \
                src/qt/locale/traff_sk.ts \
                src/qt/locale/traff_sv.ts \
                src/qt/locale/traff_vi.ts \
                src/qt/locale/traff_zh_CN.ts \
                src/qt/locale/traff_zh_TW.ts
