Contributing to Traff Core
============================

The Traff Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Traff Core project, and is not to be
confused with overall Traff Network Protocol consensus changes.

Whether a pull request is merged into Traff Core rests with the project merge
...
Patches that change Traff consensus rules are considerably more involved than
...
Where a patch set proposes to change the Traff consensus, it must have been
...
The project leader is the release manager for each Traff Core release.
